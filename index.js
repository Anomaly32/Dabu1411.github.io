...
app.post('/inreg', function(req, res){
  var dateFormular= new formidable.IncomingForm()
	dateFormular.parse(req, function(err, fields, files){
		...
		var textFisier= fs.readFileSync("resurse/json/useri.json") //cale relativa la index.js
      ...
      dataInreg: new Date(),
			rol: "user",
      nrOreJoc: fields.nrOreJoc,
		  preferinte: fields.preferinte,   // ["miau", "chit"] "miau,chit"
			tipGamer: fields.tipGamer
		}
